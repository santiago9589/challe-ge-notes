            ...
            <motion.article
                ...
                <section className="absolute top-0 right-0 flex p-2 ">
                    <section >
                        {
                            note.isArchived ? (
                                <section className="text-green-500" data-testid="Archived" onClick={() => {
                                    actions.dispatch({
                                ...
                                <section className="text-green-500" data-testid="unArchived" onClick={() => {
                                    actions.dispatch({
                    ...
                    <section >
                        {
                            !note.isArchived ? (
                                <section data-testid="editUnArchived" onClick={() => {
                                    handleEdit()
                    ...
                    <section data-testid="deleteFiles" onClick={() => handleDelete()} className="text-red-500">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
